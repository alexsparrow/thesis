...
is shown in Figure~\ref{fig:wpol_ele_sel_antisel} before and after the \MT cut.
...
derived from a data-driven method. The degree to which this template correctly
models the actual background contamination has been tested in simulation and
shown to be adequate as far as can be judged within the limited statistics of
