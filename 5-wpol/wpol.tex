...
Section~\ref{sec:electron_opt}.

\subsection{Electron Channel Cut Flow Optimisation}
...
quantified by the uncertainty obtained in the final template fit.
...
appropriate simulated sample was used. In the case of the \Zjets and \ttbar, the
generator setup was as for the \Wjets sample - the \ac{MADGRAPH} matrix element
generator interfaced to \ac{PYTHIA}. In the case of the \ac{QCD} background, a
number of samples were used. In the case of the Muon channel, this was a sample
generated using \ac{PYTHIA} and binned in terms of the transverse momentum of
the hard interaction, \pthat. This ensures adequate statistics even in the
regions of high \pthat that will tend to pass the analysis selection.
