...
\caption{The shape of the data \LP distribution and relevant backgrounds for two sets of electron ID cuts \subref{fig:wpol_wp80} WP80 and \subref{fig:wpol_wp70} WP70}
\label{fig:wpol_met_vs_mt_templates}
\end{figure}
