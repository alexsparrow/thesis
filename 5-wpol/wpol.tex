...
\item A cut on the muon transverse momentum, $\Ptmu > \unit{20}{\GeV}$ to ensure
  compatibility with trigger requirements evolving as the \ac{LHC} luminosity
  increased.
...
Electrons are naturally (why???) less cleanly measurable objects than muons. The
