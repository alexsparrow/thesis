...
experiment, a ``re-diced'' \LP distribution is constructed from \ac{MC}
pseudodata (in the selected sample). This involves randomly fluctuating, or
``re-dicing'', the bins of the \LP template according to their statistical
uncertainties.
