...
model each helicity state. This is used to derive shape templates for the \LP
variable, one for each helicity state. The next section will describe closure
tests performed to validate this procedure.
