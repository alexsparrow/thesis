...
distribution in bins of \PtW, \YW and charge. They are effectively the helicity
fractions ``baked in'' to the \ac{MC}. The factor, $Q_i$, will then re-weight
the $\cos\thetastar$ distribution in \ac{MC} so that it corresponds to the pure
helicity state, $i$. The functional form of the $\sigma_i$ is taken from
