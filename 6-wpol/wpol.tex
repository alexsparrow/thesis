...
\begin{figure}[h!]
\centering
\subfloat[\Pgmp]{\label{fig:wpol_fit_mu_plus}\includegraphics[width=0.42\textwidth]{fig/muon_MC_WHelicityFramePlots_PlusICVar}}\quad
\subfloat[\Pgmm]{\label{fig:wpol_fit_mu_minus}\includegraphics[width=0.42\textwidth]{fig/muon_MC_WHelicityFramePlots_MinusICVar}}
...
\begin{figure}[h!]
\centering
\subfloat[\Pep]{\label{fig:wpol_fit_ele_plus}\includegraphics[width=0.42\textwidth]{fig/electron_MC_WHelicityFramePlots_PlusICVar}}\quad
\subfloat[\Pem]{\label{fig:wpol_fit_ele_minus}\includegraphics[width=0.42\textwidth]{fig/electron_MC_WHelicityFramePlots_MinusICVar}}\\
