...
\caption{Comparison of data and Monte Carlo in the electron channel with all
  selection requirements applied. The \ac{QCD} contribution in each case is
  taken from the anti-selected data sample. Its normalisation has been chosen by
  subtracting the total electroweak background yield from that observed in data
  and scaling the anti-selected sample to fit the remainder.}
...
\caption{Comparison of data and Monte Carlo in the electron channel with all
  selection requirements applied.}
\label{fig:wpol_datamc_ele}
\end{figure}
