...
\end{equation}
This reflects the fact that the parameter of interest is actually the difference
between the left-handed and right-handed helicity fractions. It should be noted
that since all helicity fractions must be non-negative,
...
seen to increase the overall systematic uncertainty.
