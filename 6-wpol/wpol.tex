...
\begin{equation*}
Q_i\left(\cos\thetastar, \PtW, \YW, \pm \right) =
\frac{\left.\displaystyle\int_{b}^{b+\Delta\cos\thetastar} d\left(\cos\thetastar\right)\sigma^\pm_i\middle/\displaystyle\int_{-1}^{1}d\left(\cos\thetastar)\sigma^\pm_i\right.}{
\left.\displaystyle\int_{b}^{b+\Delta\cos\thetastar} d(\cos\thetastar)\displaystyle\sum_{i=-1}^{i=+1}
\ffi^\pm\left(\PtW, \YW\right)\sigma^\pm_i\middle/
\displaystyle\int_{-1}^{1} d(\cos\thetastar)\ffi^\pm\left(\PtW, \YW\right)\sigma^\pm_i\right.
},
\end{equation*}
