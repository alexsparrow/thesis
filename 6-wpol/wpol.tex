...
boson. Both factors are then used to re-weight \PW \ac{MC} events in order to
model each of the polarisation states. This will be used to derive shape
templates for the \LP variable. The next section will describe closure tests
