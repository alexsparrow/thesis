...
where these events are often a significant background. Finally, the neutrino in
the leptonic decay mode provides a source of ``real'' missing energy which can
be useful in the understanding of detector effects relevant to searches for
...
Shown in Figure~\ref{fig:wpol_costheta} are $\cos\thetastar$ distributions at
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{fig/MC_CosThetaStar1Plus}
