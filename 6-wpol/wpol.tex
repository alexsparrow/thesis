...
\begin{equation*}
Q_i\left(\cos\thetastar, \PtW, \YW, \pm \right) =
\frac{\displaystyle\int_{b}^{b+\Delta\cos\thetastar} \textrm{d}\left(\cos\thetastar\right) \sigma^\pm_i}{
\displaystyle\int_{-1}^{1}\textrm{d}\left(\cos\thetastar\right)\sigma^\pm_i} \div
\frac{\displaystyle\int_{b}^{b+\Delta\cos\thetastar} \textrm{d}\left(\cos\thetastar) \displaystyle\sum_{i=-1}^{i=+1}
\ffi^\pm\left(\PtW, \YW\right)\sigma^\pm_i}{
\displaystyle\int_{-1}^{1} \textrm{d}\left(\cos\thetastar) \ffi^\pm\left(\PtW, \YW\right)\sigma^\pm_i
}
\end{equation*}
...
% },
% \end{equation*}
where $b$ indicates a bin within the $\cos\thetastar$ distribution and the
