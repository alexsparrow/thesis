...
boson. Both factors are then used to re-weight \Wjets events in \ac{MC} in order
to model each of the polarisation states. This is used to derive shape templates
for the \LP variable. The next section will describe closure tests performed to
