...
\begin{equation*}
Q_i\left(\cos\thetastar, \PtW, \YW, \pm \right) =
\frac{\displaystyle\int_{b}^{b+\Delta\cos\thetastar} \sigma^\pm_i\left(\cos\thetastar\right)}{
\displaystyle\int_{-1}^{1}\sigma^\pm_i \left(\cos\thetastar\right)} \div
\frac{\displaystyle\int_{b}^{b+\Delta\cos\thetastar} \sum_{i=-1}^{i=+1}\left(\cos\thetastar\right)
\ffi^\pm\left(\PtW, \YW\right)\sigma^\pm_i}{
\displaystyle\int_{-1}^{1} \ffi^\pm\left(\PtW, \YW\right)\sigma^\pm_i\left(\cos\thetastar\right)
}
\end{equation*}
