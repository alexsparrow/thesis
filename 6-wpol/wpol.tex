...
\begin{figure}[h!]
  \centering
  \subfloat[]{\label{fig:wpol_mht_res1}\includegraphics[width=0.49\textwidth]{fig/mht_res1.png}}
  \subfloat[]{\label{fig:wpol_mht_res2}\includegraphics[width=0.49\textwidth]{fig/mht_res2.png}}
...
\begin{figure}[h!]
\centering
\subfloat[$\Ptl\left(\Pelectron\right)$]{\label{fig:wpol_datamc_ele_leppt_plus}\includegraphics[width=0.32\textwidth]{fig/ele_LeptonPtPlus}}
\subfloat[$\LP\left(\Pelectron\right)$]{\label{fig:wpol_datamc_ele_lp_plus}\includegraphics[width=0.32\textwidth]{fig/ele_ICVarPlus}}
\subfloat[$\PtW\left(\Pelectron\right)$]{\label{fig:wpol_datamc_ele_wpt_plus}\includegraphics[width=0.32\textwidth]{fig/ele_WPtPlus}}\\
\subfloat[$\Ptl\left(\APelectron\right)$]{\label{fig:wpol_datamc_ele_leppt_minus}\includegraphics[width=0.32\textwidth]{fig/ele_LeptonPtMinus}}
\subfloat[$\LP\left(\APelectron\right)$]{\label{fig:wpol_datamc_ele_lp_minus}\includegraphics[width=0.32\textwidth]{fig/ele_ICVarMinus}}
\subfloat[$\PtW\left(\APelectron\right)$]{\label{fig:wpol_datamc_ele_wpt_minus}\includegraphics[width=0.32\textwidth]{fig/ele_WPtMinus}}\\
...
\begin{figure}[h!]
\centering
\subfloat[$\Ptl\left(\Pmuon\right)$]{\label{fig:wpol_datamc_mu_leppt_plus}\includegraphics[width=0.32\textwidth]{fig/datamc_ptmuonplus}}
\subfloat[$\LP\left(\Pmuon\right)$]{\label{fig:wpol_datamc_mu_lp_plus}\includegraphics[width=0.32\textwidth]{fig/datamc_lpvarplus}}
\subfloat[$\PtW\left(\Pmuon\right)$]{\label{fig:wpol_datamc_mu_mt_plus}\includegraphics[width=0.32\textwidth]{fig/datamc_recoptwplus}}\\
\subfloat[$\Ptl\left(\APmuon\right)$]{\label{fig:wpol_datamc_mu_leppt_minus}\includegraphics[width=0.32\textwidth]{fig/datamc_ptmuonminus}}
\subfloat[$\LP\left(\APmuon\right)$]{\label{fig:wpol_datamc_mu_lp_minus}\includegraphics[width=0.32\textwidth]{fig/datamc_lpvarminus}}
\subfloat[$\PtW\left(\APmuon\right)$]{\label{fig:wpol_datamc_mu_mt_minus}\includegraphics[width=0.32\textwidth]{fig/datamc_recoptwminus}}
...
\begin{figure}[h!]
\centering
\subfloat[\Pgmp]{\label{fig:wpol_fit_mu_plus}\includegraphics[width=0.4\textwidth]{fig/muon_MC_WHelicityFramePlots_PlusICVar}}\quad
\subfloat[\Pgmm]{\label{fig:wpol_fit_mu_minus}\includegraphics[width=0.4\textwidth]{fig/muon_MC_WHelicityFramePlots_MinusICVar}}
\caption[Results of the binned maximum likelihood fit - muons]{Results of the binned
  maximum likelihood fit in the muon channel. The left-handed helicity template
  is shown in red, the right-handed in green and the longitudinal in blue, with
  normalisations as found by the fit. The yellow and red shaded regions are the
  \ac{EWK} and \ac{QCD} background shapes respectively, where the latter is
  obtained from data.}
...
\begin{figure}[h!]
\centering
\subfloat[\Pep]{\label{fig:wpol_fit_ele_plus}\includegraphics[width=0.4\textwidth]{fig/electron_MC_WHelicityFramePlots_PlusICVar}}\quad
\subfloat[\Pem]{\label{fig:wpol_fit_ele_minus}\includegraphics[width=0.4\textwidth]{fig/electron_MC_WHelicityFramePlots_MinusICVar}}\\
\caption{Results of the binned maximum likelihood fit in the electron
  channel. The left-handed helicity template is shown in red, the right-handed
  in green and the longitudinal in blue, with normalisations as found by the
  fit. The yellow and red shaded regions are the \ac{EWK} and \ac{QCD}
  background shapes respectively, where the latter is obtained from data.}
...
\begin{figure}[h!]
\centering
\subfloat[\Pep]{\label{fig:wpol_contour_ele_plus}\includegraphics[width=0.4\textwidth]{fig/electron_contour_plus}}\quad
\subfloat[\Pepm]{\label{fig:wpol_contour_ele_minus}\includegraphics[width=0.4\textwidth]{fig/electron_contour_minus}}
...
\begin{figure}[h!]
\centering
\subfloat[\Pgmp]{\label{fig:wpol_contour_mu_plus}\includegraphics[width=0.4\textwidth]{fig/muon_contour_plus}}\quad
\subfloat[\Pgmm]{\label{fig:wpol_contour_mu_minus}\includegraphics[width=0.4\textwidth]{fig/muon_contour_minus}}
...
\begin{figure}[h!]
\centering
\subfloat[]{\label{fig:wpol_contour_comb_plus}\includegraphics[width=0.4\textwidth]{fig/combined_contour_plus}}\quad
\subfloat[]{\label{fig:wpol_contour_comb_minus}\includegraphics[width=0.4\textwidth]{fig/combined_contour_minus}}
