...
\begin{equation*}
Q_i\left(\cos\thetastar, \PtW, \YW, \pm \right) =
\left.\frac{\displaystyle\int_{b}^{b+\Delta\cos\thetastar} \sigma^\pm_i \textrm{d}\cos\thetastar}{
\displaystyle\int_{-1}^{1}\sigma^\pm_i \textrm{d}\cos\thetastar} \middle/
\frac{\displaystyle\int_{b}^{b+\Delta\cos\thetastar} \displaystyle\sum_{i=-1}^{i=+1}
\ffi^\pm\left(\PtW, \YW\right)\sigma^\pm_i}{
\displaystyle\int_{-1}^{1}\ffi^\pm\left(\PtW, \YW\right)\sigma^\pm_i
}\right.
\end{equation*}
