...
Q_i\left(\cos\thetastar, \PtW, \YWm, \pm \right) =
...
\begin{equation*}
R_i\left(\PtW, \YWm, \pm\right) =
\frac{{f'}_i \left(\PtW, \YWm, \pm\right)}{{f'}_i^{\textrm{all}}},
\end{equation*}
where ${f'}_i\left(\PtW, \YWm, \pm\right)$ is the fraction of \PW bosons in the
appropriate \PtW and \YWm bin with helicity $i$. ${f'}_i^{\textrm{all}}$ is the
