\ctable[
  cap=Summary of the \PW polarisation fit results for the \acs{QCD} background,
  ...
  correlation with the polarisation fit parameters is also given. The
  uncertainties quoted are purely statistical.,
