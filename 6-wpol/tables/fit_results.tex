...
for each measurement. The correlation between the two parameters is also shown
for each case as well as the $\chi^2$/ndof measure of the goodness-of-fit.},
