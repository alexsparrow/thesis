...
is illustrated in Figure~\ref{fig:expt_lhc}. Each stage supplies an incremental
...
\caption{The \ac{LHC} accelerator complex.}
\label{fig:expt_lhc}
\end{figure}
...
electrons, muons are able to provide a much finer mass resolution. This is an
important advantage for a variety of physics searches and measurements at
\ac{CMS}. The muon system is responsible for muon identification, momentum
measurement and triggering (for further detail see
...
ones, with a consequent reduction in the data size. Monte Carlo events are
...
detector response has been simulation, Monte Carlo is processed in exactly the
same manner as data.
