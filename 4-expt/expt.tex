...
\begin{figure}[h!]
\includegraphics[width=0.9\textwidth]{fig/lhc-pho-1993-008_cropped}
...
\caption[Diagram showing the organisation of the \ac{CMS} \ac{L1T}]{Diagram
...
trigger tower energies summed in to larger ``\ac{RCT} regions''. These consist
