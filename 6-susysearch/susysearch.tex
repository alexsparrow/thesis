...
templates for each \STlep bin.

As in the \PW polarisation analysis, a fit is performed using templates taken
from the electroweak backgrounds taken from simulation. To avoid the potential
effects of signal contamination, the fit region is confined to \LPcontrol.
