...
disfavour a number of toplogies which would appear in a larger class of
...
\begin{figure}
\centering
\subfloat[]{\label{fig:wpol_contour_comb_plus}\includegraphics[width=0.45\textwidth]{fig/T3w}}\quad
\subfloat[]{\label{fig:wpol_contour_comb_minus}\includegraphics[width=0.45\textwidth]{fig/T2tt}}
\caption{}
