...
% The first topology, T1 arises from pair production of neutral, coloured objects
...
% the neutralinos and charginos respectively. Importantly, $\tilde{X}^0_1$ is
% defined to be the lightest superpartner - a dark matter candidate and the source
% of missing energy in the events.
