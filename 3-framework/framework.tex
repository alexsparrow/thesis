...
One such theory that has often been used is the \ac{CMSSM}. The \ac{CMSSM}
reduces the parameter space of the \ac{MSSM} to just 4 parameters. Four of these
are continuous:
\begin{itemize}
...
the absence of the off-shell squark, the jet multiplicity is reduced.
