...
the neutrino (see Figure~\ref{fig:w1jet_modes_1a}). Due to the \VminusA
...
\PWp is shown in Figure~\ref{fig:framework_ptw}. Firstly, the increase of \fLmfR
...
\caption{The polarisation fractions \fL, \fR and \f0 as a function of \PtW for
  ...
  Figures~\ref{fig:framework_ptw_fL}, \ref{fig:framework_ptw_fR} and
