...
squarks. These are theoretically attractive for a number of reasons (see
\cite[{p.~202}]{sparticles} and \cite{light_stop}). Since this does not contain an
intermediate mass state, it has only two paramters: the mass of the mother,
\Mstop and the mass of the daugther, \Mlsp.
