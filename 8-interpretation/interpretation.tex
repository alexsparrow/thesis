...
\subfloat[Statistical Uncertainties Only]{
  \label{fig:inter_pl_80_240_syst}\includegraphics[width=0.47\textwidth]{fig/exp_muon_electron_80_240_bgsysts_no_sigsysts_no_sigcon_no}}\quad
\subfloat[Background Systematics]{
  \label{fig:inter_pl_80_240_muon}\includegraphics[width=0.47\textwidth]{fig/exp_muon_electron_80_240_bgsysts_yes_sigsysts_no_sigcon_no}}\\
\subfloat[Signal Systematics]{
  \label{fig:inter_pl_80_400_syst}\includegraphics[width=0.47\textwidth]{fig/exp_muon_electron_80_240_bgsysts_yes_sigsysts_yes_sigcon_no}}\quad
\subfloat[Signal Contamination]{
  \label{fig:inter_pl_80_400_muon}\includegraphics[width=0.47\textwidth]{fig/exp_muon_electron_80_240_bgsysts_yes_sigsysts_yes_sigcon_yes}}\\
\subfloat[Muon Channel Only]{
  \label{fig:inter_pl_80_400_muon}\includegraphics[width=0.47\textwidth]{fig/exp_muon_80_240_bgsysts_yes_sigsysts_yes_sigcon_yes}}
\caption[]{}
\label{fig:cls1}
\end{figure}
...
\centering
\subfloat[Statistical Uncertainties Only]{
  \label{fig:inter_pl_80_240_syst}\includegraphics[width=0.47\textwidth]{fig/exp_muon_electron_80_400_bgsysts_no_sigsysts_no_sigcon_no}}\quad
\subfloat[Background Systematics]{
  \label{fig:inter_pl_80_240_muon}\includegraphics[width=0.47\textwidth]{fig/exp_muon_electron_80_400_bgsysts_yes_sigsysts_no_sigcon_no}}\\
\subfloat[Signal Systematics]{
  \label{fig:inter_pl_80_400_syst}\includegraphics[width=0.47\textwidth]{fig/exp_muon_electron_80_400_bgsysts_yes_sigsysts_yes_sigcon_no}}\quad
\subfloat[Signal Contamination]{
  \label{fig:inter_pl_80_400_muon}\includegraphics[width=0.47\textwidth]{fig/exp_muon_electron_80_400_bgsysts_yes_sigsysts_yes_sigcon_yes}}\\
\subfloat[Muon Channel Only]{\label{fig:inter_pl_80_400_muon}\includegraphics[width=0.47\textwidth]{fig/exp_muon_80_400_bgsysts_yes_sigsysts_yes_sigcon_yes}}
\caption[]{}
\label{fig:cls2}
\end{figure}
...
\begin{figure}
\centering
\subfloat[]{\label{fig:inter_t2tt_mu_eff250}\includegraphics[width=0.49\textwidth]{fig/sms_muons_eff_250}}
\subfloat[]{\label{fig:inter_t2tt_mu_eff350}\includegraphics[width=0.49\textwidth]{fig/sms_muons_eff_350}}\\
\subfloat[]{\label{fig:inter_t2tt_mu_eff450}\includegraphics[width=0.49\textwidth]{fig/sms_muons_eff_450}}
\subfloat[]{\label{fig:inter_t2tt_mu_efftot}\includegraphics[width=0.49\textwidth]{fig/sms_muons_eff_total}}
\caption[]{}
...
\begin{figure}
\centering
\subfloat[]{\label{fig:inter_t2tt_el_eff250}\includegraphics[width=0.49\textwidth]{fig/sms_electrons_eff_250}}
\subfloat[]{\label{fig:inter_t2tt_el_eff350}\includegraphics[width=0.49\textwidth]{fig/sms_electrons_eff_350}}\\
\subfloat[]{\label{fig:inter_t2tt_el_eff450}\includegraphics[width=0.49\textwidth]{fig/sms_electrons_eff_450}}
\subfloat[]{\label{fig:inter_t2tt_el_efftot}\includegraphics[width=0.49\textwidth]{fig/sms_electrons_eff_total}}
\caption[]{}
...
\begin{figure}
\includegraphics[width=\textwidth]{fig/sms_limit}
\end{figure}
