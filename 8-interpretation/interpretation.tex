...
is the one-sided profile likelihood ratio, $q$~\cite{cl_computation, modified_frequentist, atlas_cms_higgs}.
...
\caption[]{Distribution of the profile likelihood ratio test statistic for null
  ...
  400)$. The values of \CLb, \CLs+b and \CLs are also shown.}
\label{fig:inter_cls}
\end{figure}
...
\begin{figure}[h!]
\centering
\subfloat[\Pmu $x=0.25$]{\label{fig:inter_t3w_mu_efftot}\includegraphics[width=0.49\textwidth]{fig/t3w_0p75_muons_eff_total}}
\subfloat[\Pe $x=0.25$]{\label{fig:inter_t3w_el_efftot}\includegraphics[width=0.49\textwidth]{fig/t3w_0p75_electrons_eff_total}}\\
\subfloat[\Pmu $x=0.5$]{\label{fig:inter_t3w_mu_efftot}\includegraphics[width=0.49\textwidth]{fig/t3w_0p50_muons_eff_total}}
\subfloat[\Pe $x=0.5$]{\label{fig:inter_t3w_el_efftot}\includegraphics[width=0.49\textwidth]{fig/t3w_0p50_electrons_eff_total}}\\
\subfloat[\Pmu $x=0.75$]{\label{fig:inter_t3w_mu_efftot}\includegraphics[width=0.49\textwidth]{fig/t3w_0p25_muons_eff_total}}
\subfloat[\Pe $x=0.75$]{\label{fig:inter_t3w_el_efftot}\includegraphics[width=0.49\textwidth]{fig/t3w_0p25_electrons_eff_total}}
...
The limits for the each value of $x$ (0.25, 0.5 and 0.75) are shown in
