...
below the diagonal has been excluded from the limit. This excluded range was
...
\unit{100}{\GeV}$ was excluded. For $x=0.25$, \Mchargino is close to \Mlsp and
presumably the efficiency is more sensitive to the modellling of \ac{ISR}. In
this case the region, $\Mgluino - \Mlsp < \unit{140}{\GeV}$ was ignored.
