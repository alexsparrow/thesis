...
chapters. The work presented in this thesis, in common with many analyses at
\ac{CMS} makes extensive use of missing energy type quantities. This quantity
depends on accurate determination of the energies and directions of all
particles in the event. The \ac{PF} algorithm is designed to combine information
from all \ac{CMS} subdetectors in order to reconstruct all stable particles in
the event. As will be seen, this provides the highest resolution measurement of
missing energy at \ac{CMS}.
