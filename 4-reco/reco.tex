...
\begin{figure}
\includegraphics[width=0.9\textwidth]{fig/pf_jet_energyres}
...
\begin{figure}
\includegraphics[width=0.9\textwidth]{fig/pf_jet_etaphires}
...
\begin{figure}
\includegraphics[width=0.9\textwidth]{fig/pf_met_res}
