\ctable[
cap=Simple cut-based electron idenitification,
caption=Cut values for the simple cut-based electron indentification working points~\cite{simple_eleid_web}.,
...
\CombIso $<$        & 0.1   & 0.07  & 0.06  & 0.06  & 0.03  & 0.02 \NN
