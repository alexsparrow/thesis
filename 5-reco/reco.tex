...
\begin{figure}
\centering
\subfloat[]{\label{fig:reco_ele_fake_rate_a}\includegraphics[width=0.45\textwidth]{fig/ele_fake_rate_a}}\quad
\subfloat[]{\label{fig:reco_ele_fake_rate_b}\includegraphics[width=0.45\textwidth]{fig/ele_fake_rate_b}}
