...
\begin{figure}[htbp!]
\centering
\subfloat[Barrel]{\label{fig:reco_ele_id_a}\includegraphics[width=0.45\textwidth]{fig/ele_id_a}}\quad
\subfloat[Endcap]{\label{fig:reco_ele_id_b}\includegraphics[width=0.45\textwidth]{fig/ele_id_b}}\\
\subfloat[Barrel]{\label{fig:reco_ele_id_a}\includegraphics[width=0.45\textwidth]{fig/ele_id_c}}\quad
\subfloat[Endcap]{\label{fig:reco_ele_id_b}\includegraphics[width=0.45\textwidth]{fig/ele_id_d}}\\
\subfloat[Barrel]{\label{fig:reco_ele_id_a}\includegraphics[width=0.45\textwidth]{fig/ele_id_e}}\quad
\subfloat[Endcap]{\label{fig:reco_ele_id_b}\includegraphics[width=0.45\textwidth]{fig/ele_id_f}}\\
\subfloat[Barrel]{\label{fig:reco_ele_id_a}\includegraphics[width=0.45\textwidth]{fig/ele_id_g}}\quad
\subfloat[Endcap]{\label{fig:reco_ele_id_b}\includegraphics[width=0.45\textwidth]{fig/ele_id_h}}\\
\caption{}
...
\begin{figure}[htbp!]
\centering
\subfloat[Barrel]{\label{fig:reco_ele_fake_rate_a}\includegraphics[width=0.45\textwidth]{fig/ele_fake_rate_a}}\quad
\subfloat[Endcap]{\label{fig:reco_ele_fake_rate_b}\includegraphics[width=0.45\textwidth]{fig/ele_fake_rate_b}}\\
\subfloat[Barrel]{\label{fig:reco_ele_fake_rate_a}\includegraphics[width=0.45\textwidth]{fig/ele_fake_rate_c}}\quad
\subfloat[Endcap]{\label{fig:reco_ele_fake_rate_b}\includegraphics[width=0.45\textwidth]{fig/ele_fake_rate_d}}
\caption{}
