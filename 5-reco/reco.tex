...
measurement~\cite{cms_pas_ewk_10_002} and has been used in this work. The
...
\label{sec:reco_pf}
The \ac{PF} algorithm~\cite{cms_pf_pas, cms_pf_pas2} attempts to provide a global
...
the jet energy and thus also of \MET.
