...
\caption[Distribution of the \LP variable in the three highest \STlep bins as
  measured in the muon control sample]{Distribution of the \LP variable in the three highest \STlep bins as
  measured in the muon control sample. \ac{MC} distributions for \ac{SM}
...
distribution in simulated \Wenu events]{The effect of a 15\% shift of \fLmfR on
...
\begin{figure}[h!]
  ...
  \caption[Comparison of the \LP shapes between data and \ac{MC} for the muon
  and electron channels]{Comparison of the \LP shapes between data and \ac{MC}
    for the muon and electron channels. Distributions are shown for the three
    highest \STlep bins used for the search. \ac{MC} distributions for the
    \ac{SM} subprocesses are also shown.}
...
\STlep]{Comparison of the number of events observed in the data and the
  ...
  \STlep. Results are shown for \subref{fig:susy_pred_mu} the muon channel and
  \subref{fig:susy_pred_el} the electron channel.  The red error-bars indicate
