...
uncertainties with the muon channel, a ``corrected \RCS'' is calculated from the
results of the fit. The systematic uncertainties are then calculated in terms of
this variable. For the limit procedure, it is technically simpler to use the fit
...
events. The additional uncertainties introduced by this procedure will be
covered in \sec~\ref{sec:susy_systematics}.
...
uncertainty quoted in Table~\ref{tbl:susy_syst_electrons}, this is propagated into
