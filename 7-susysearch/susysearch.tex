...
\fig~\ref{fig:susy_elqcd}. The predictions of the \ac{QCD} and
...
of the fit. The systematic uncertainties are then evaluated in terms of this
variable. For the limit procedure described in \chap~\ref{sec:interpretation},
it is technically simpler to use the fit results to correct the control region
yield in order to subtract the \ac{QCD} contribution. Since the \ac{QCD}
contamination in the signal region is negligible, this does not make a
significant difference to the limit.
...
and \ac{QCD} events. The additional uncertainties introduced by this procedure
will be covered in \sec~\ref{sec:susy_systematics}.
