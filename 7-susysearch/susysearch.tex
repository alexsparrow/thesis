...
(see \sec~\ref{sec:wpol_systematics}).
...
\sec~\ref{sec:wpol_syst_ele_bgest}. The templates are flcutuated randomly 200
...
evaluated by studying the agreement between data and Monte Carlo in \Zjets
...
Monte Carlo are shown in \fig~\ref{fig:susy_datamc} for the three \STlep bins
