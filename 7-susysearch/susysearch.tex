...
prediction of jet multiplicity by the \ac{MC} generator. The \PW polarisation is
known to depend only weakly on the jet multiplicity and hence this uncertainty
can be neglected.
