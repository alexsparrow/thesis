...
pdfkeywords = {CMS, LHC, SUSY, Physics, Supersymmetry, W Boson, Polarisation},
...
\begin{appendices}
 ...
 \import{appendices/}{service_work}
 \import{appendices/}{mc_samples}
 \chapter{List of Acronymns}\input{acronyms}
\end{appendices}

\begin{comment}
  \input{appendices/kinematics}
  \input{appendices/statistics}
  \input{appendices/service_work}
  \input{appendices/mc_samples}
\end{comment}
