...
\begin{figure}
\includegraphics[width=0.8\textwidth]{fig/drawing}
\end{figure}

\subsection{Silicon Tracker}
The innermost subsystem of \ac{CMS} is the silicon tracker. This can be further
subdivided according to the expected particle flux at design luminosity.
...
at $|z|=34.5, \unit{46.5}{\cm}$. The pixel modules in these layers are arrange
in a turbine layout.
...
comprising a further 6. The innermost two layers use stereo modules with two
sublayers of silicon strips with a \unit{100}{\milli\radian} stereo angle
between them. This gives a resolution of \unit{23-34}{\micro\metre} in the
$r\phi$ direction and \unit{230}{\micro\metre} in $z$.
