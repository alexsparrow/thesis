...
statistical interpretations is the construction of an appopriate likelihood
...
the bacground yield depends only on the nuisance parameters, $\nu^{(k)}$, where
...
overprediction of the background. To correct this, an additional factor is
