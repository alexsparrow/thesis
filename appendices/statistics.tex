...
where
\begin{itemize}
\item \RCSi is the translation ratio as defined in Equation~\ref{eqn:susysearch_RCS},
...
\item Systematic uncertainties arising from detector artefacts or theoretical
  uncertainties such as jet energy scale, standard model cross-section
...
nuisance parameter will be included for all bins. This achieves the desired
...
; \nu^{\textrm{SM}}_i \right)
\end{equation}
The term included in the background prediction (Equation~\ref{eqn:bgprediction})
is modified to
\begin{equation}
...
parameters representing these uncertainties. The relevant terms were set up but
