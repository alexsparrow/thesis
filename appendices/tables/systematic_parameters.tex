...
\tnote[d]{The signal contamination nuisance parameters are correlated in the
sense that they are related to the signal strength. For further details,
see \sec~\ref{sec:inter_sig_contam}.}
...
Signal Contamination               & \tmark[d]  &            &            & \checkmark & $\nu^{\textrm{sig cont}}_i$\NN
